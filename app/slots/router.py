...
async def create_slot(
    ...
    """
    slot = await service.create_slot_service(db, slot_create)
    return slot
...
async def get_available_slots(
    ...
    """
    slots = await service.get_available_slots_service(db)
    return slots
...
async def get_slot_by_id(
    ...
    """
    slot = await service.get_slot_by_id_service(db, slot_id)
    return slot
...
async def get_all_slots(
    ...
    """
    slots = await service.get_all_slots_service(db)
    return slots
